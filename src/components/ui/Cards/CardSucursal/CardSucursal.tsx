    ...
    <Card sx={{ maxWidth: 400, margin: 2, boxShadow: 3, borderRadius: 2 }}>
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary">
          <strong>Casa Matriz:</strong> {sucursal.esCasaMatriz ? <CheckCircleOutline sx={{ color: '#367E7F' }} /> : <HighlightOff sx={{ color: '#f44336' }} />}
        </Typography>
      </CardContent>
      <Box sx={{ display: 'flex', justifyContent: 'center', p: 2 }}>
        <Button
          ...
          variant="contained"
          sx={{ bgcolor: '#FE5A1D', '&:hover': { bgcolor: '#FFA500' }, mr: 1 }}
          startIcon={<Edit />}
        >
          Editar
        </Button>
